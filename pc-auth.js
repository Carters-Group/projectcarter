...
(function () {
  ...
  var api = {
    ...
    /* uploads to the "avatars" bucket at <user id>/avatar.<ext> (overwriting
    ...
    uploadAvatar: function (file) {
      ...
      if (!/^image\//.test(file.type)) return Promise.resolve({ error: { message: "Choose an image file." } });
      ...
      return client.storage.from("avatars").upload(path, file, { upsert: true, cacheControl: "3600" })
        .then(function (res) {
